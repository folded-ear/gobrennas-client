...
import { BfsId, bfsIdEq, ensureString } from "./identity";
...
describe("identity", () => {
    ...
    describe("bfsIdEq", () => {
        ...
        it("should equate null, even though TS won't let you pass one", () => {
            expect(
                bfsIdEq(null as unknown as BfsId, null as unknown as BfsId),
            ).toBe(true);
            expect(bfsIdEq(null as unknown as BfsId, "abc")).toBe(false);
            expect(bfsIdEq(123, null as unknown as BfsId)).toBe(false);
        });
        it("should equate undefined, even though TS won't let you pass one", () => {
            expect(
                bfsIdEq(
                    undefined as unknown as BfsId,
                    undefined as unknown as BfsId,
                ),
            ).toBe(true);
            expect(bfsIdEq(undefined as unknown as BfsId, "abc")).toBe(false);
            expect(bfsIdEq(123, undefined as unknown as BfsId)).toBe(false);
        });
    });
});
