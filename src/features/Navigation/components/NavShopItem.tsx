import {CheckBoxOutlineBlankOutlined as ShopIcon, CheckBoxOutlined as ActiveShopIcon,} from "@mui/icons-material";
...
export const NavShopItem: React.FC<NavShopItemProps> = ({onSelect, expanded, name, color, id}) => {
